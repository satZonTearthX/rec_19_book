...
//import com.paradeto.recommend.ToVector.Step1_ToItemPreMapper;
//import com.paradeto.recommend.ToVector.Step1_ToUserVectorReducer;

/**
 * 对评分向量和共现矩阵进行整理
 *
 */
public class ToTransposion {
	...
	public static void run1(Map<String, String> path) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(ToTransposion.class);
