	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="authorname" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写店铺主人名'" /></td>
            </tr>
            <!-- <tr>
                <td width="60" align="right">图书数量:</td>
                <td><input type="text" name="booknumber" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:1,precision:0, missingMessage:'请填写图书数量'" /></td>
            </tr> -->
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">店铺主人名:</td>
                <td><input type="text" id="edit-authorname" name="authorname" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写店铺主人名'" /></td>
            </tr>
            <!-- <tr>
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-authorname").val(item.authorname);
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'authorname',title:'店铺主人名称',width:180,sortable:true},
