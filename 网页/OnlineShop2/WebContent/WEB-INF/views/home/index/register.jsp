...
<body>
	...
	<div class="main">
		...
		<div class="login-form-left fl">
			<dl class="func clearfix">
				<dt>注册之后您可以</dt>
				<dd class="ico05"><i></i>购买图书支付订单</dd>
				<dd class="ico01"><i></i>查看各类销售图书</dd>
				<dd class="ico03"><i></i>收藏关注喜欢图书</dd>
				<dd class="ico02"><i></i>个性推荐量身定制</dd>
				<dd class="ico06"><i></i>服务评价及时反馈</dd>
				<dd class="ico04"><i></i>安全交易诚信无忧</dd>
			</dl>
			<div class="if" height=100%>
				<h2>如果您是本站用户</h2>
	...
	<div class="main">
		<div class="if">
			<h2 id="choosecat" style='display:none'>选择您喜欢的类别</h2>
			<div id="cats" class="order-evaluation-checkbox">
			 ...
			 <a  id="regaccimage" >提交</a>
		</div>
	</div>
	<div class="footer clear wrap1000">
		<p> <a href="/OnlineShop">首页</a> | <a href="">联系我们</a></p>
		<p>Copyright 2019 非常4+2 Inc.,All rights reserved.</p>
	</div>
</body>
<script type="text/javascript" src="OnlineShop/WebContent/WEB-INF/views/home/index/js/jquery.min.js"></script>
		...
		$.ajax({
			...
			success:function(data){
				if(data.type == 'success'){
					...
					document.getElementById('choosecat').style.display = "block";
					//document.getElementById('regaccimage').style.display = "block";
