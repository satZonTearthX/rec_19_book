...
<body>
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">响当当商城</a></b>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/OnlineShop"><img src="../resources/home/images/logo.png" alt="ShopCZ" /></a><span>非常4+2</span></h1></div>
		...
		<div class="shop_hd_menu">
			...
			<div class="shop_hd_menu_all_category ${allCategoryClass }" id="${allCategoryId }"><!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
				<div class="shop_hd_menu_all_category_title"><h2 title="所有商品分类"><a href="javascript:void(0);">所有图书分类</a></h2><i></i></div>
					...
					<ul class="shop_hd_menu_all_category_hd_menu clearfix">
						...
						<li id="cat_${productCategory.id }" class="">
							...
							<c:forEach items="${productCategory.children }" var="child">
								<dd class="shop_hd_menu_all_category_hd_menu clearfix">	
										<a href="../product/product_category_list?cid=${child.id }" href="">${child.text }</a>										     
								</dd>
                             </c:forEach>                       
							</div>
						</li>
