...
public class HomeProductController {
	...
	public ModelAndView index(ModelAndView model,Long id,HttpServletRequest request){
		...
		model.addObject("all_top_ratings",productService.findList(queryMap));
		model.addObject("currentHome", "current_");
		model.addObject("commentList", commentService.findList(queryMap));
		if(onlineAccount!=null) {
		model.addObject("perRecProductList", productService.findperRec(onlineAccount.getId()));}
		System.out.println(product.getId_tem());
		model.addObject("bookrecProductList", productService.findbookRec(product.getId_tem()));
