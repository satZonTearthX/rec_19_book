...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2019, 非常4+2, Ltd." />
<title>后台管理主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            ...
            <p><a href="../home/index" target="_blank">网站首页</a>|<a href="logout">退出登录</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2018 【非常4+2】 All Rights Reserved
    </div>
    <!-- end of footer -->  
