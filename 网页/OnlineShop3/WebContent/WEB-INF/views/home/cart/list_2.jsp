...
<div class="clear"></div>
		...
		<img id="paycode"  src="../resources/home/images/paycode.png" style='display:none'/>
		<button href="javascript:void(0)" id="pay-order-btn" class="op" style='display:none'>支付订单</button>
...
jQuery(function(){
	...
	$(document).ready(function(){
			...
			$.ajax({
				...
				success:function(data){
					if(data.type == 'success'){
						...
						document.getElementById('pay-order-btn').style.display="block";
						alert('下单成功!');
						oid=data.oid;
		...
		$("#pay-order-btn").click(function(){
			window.location.href = '../order/order_success?orderId='+oid;
		});
	});
